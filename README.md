...
포켓몬·원피스 카드 시세, 발매정보, 커뮤니티 사이트.

- **도메인**: https://cardpick.kr
- **호스팅**: Cloudflare Pages
- **DB + Auth**: Supabase
- **시세 자동화**: GitHub Actions (1시간 cron)
- **이미지**: Cloudflare R2
