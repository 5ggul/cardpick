...
<style>
:root{--bg:#05080D;--panel:#0D121B;--panel-2:#111722;--line:rgba(255,255,255,.08);--line-strong:rgba(255,255,255,.14);--ink:#E8EDF5;--muted:#8B96A8;--dim:#5B6577;--mint:#26E0C2;--gold:#D8B84A;--sans:"Pretendard Variable",Pretendard,-apple-system,BlinkMacSystemFont,system-ui,sans-serif;--mono:'IBM Plex Mono',ui-monospace,monospace}
...
<header class="site-header"><div class="header-inner"><a class="brand" href="/" aria-label="카드픽 홈"><img src="/logo-sm.png" alt="" width="28" height="28"><span class="name">카드픽</span><span class="en">CARDPICK</span></a><nav class="nav" aria-label="주요 메뉴"><a href="/#prices" aria-current="page">카드 시세</a><a href="/hot">트렌드</a><a href="/board">게시판</a><a href="/guides">가이드</a><a href="/tools">도구</a><a href="/releases">뉴스·발매</a></nav></div></header>
